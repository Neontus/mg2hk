...
path = '/Users/jkim/Desktop/mg2hk/testdata/'
...
iris_file = '/Users/jkim/Desktop/mg2hk/testdata/'
...
##masking code is all non-tested
offset = (sji1400.data.shape[1]-(avg_diff(slitx))*sji1400.data.shape[2])/2
#offset = 230
l_iris =len(t_iris)
...
for i, x in enumerate(slitx):
    ...
    sjit = iris_t_s[i*sji_period+3] ##innaccuracy?? where is +3 from? is this correct or needs to be generalized
